...
/* Created on:     16/06/2021 03:00:19 PM                       */
/*==============================================================*/
...
alter table DEPARTAMENTO
   drop constraint FK_DEPARTAM_JEFE_DEPA_JEFE;

alter table DOCENTE
   drop constraint FK_DOCENTE_DOCENTE_D_DEPARTAM;

alter table DOCENTE
   drop constraint FK_DOCENTE_HORASSOCI_HORAS_SO;
...
drop index JEFE_DEPARTAMENTO_FK;
...
/*==============================================================*/
/* Index: JEFE_DEPARTAMENTO_FK                                  */
/*==============================================================*/
create index JEFE_DEPARTAMENTO_FK on DEPARTAMENTO (
   IDJEFE ASC
);
...
(
   ...
   CORREDOCENTE         VARCHAR2(25)         not null,
...
alter table DEPARTAMENTO
   add constraint FK_DEPARTAM_JEFE_DEPA_JEFE foreign key (IDJEFE)
      references JEFE (IDJEFE);

alter table DOCENTE
   add constraint FK_DOCENTE_DOCENTE_D_DEPARTAM foreign key (IDDEPTO)
      references DEPARTAMENTO (IDDEPTO);

alter table DOCENTE
   add constraint FK_DOCENTE_HORASSOCI_HORAS_SO foreign key (IDHORASSOCIALES)
