      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Historial de planeaciones</a>
          </div>
...
<script language="javascript">
      ...
      foreach ($queryidcoor->result() as $coordinador){
        ...
        foreach ($queryidgrupo->result() as $grupo){
          ...
          foreach ($queryidmateria->result() as $materia){
                    ...
                    <div class="col-md-12">
                      <div class="card">
                        <div class="card-header">
                          <h4 class="card-title"><?php echo ($materia->NOMMATERIA); ?></h4>
                          <div  class="card-body">
            ...
            $queryidcopia= $this->db->query("SELECT * FROM COPIAGRUPO WHERE IDGRUPOS='".$grupo->IDGRUPOS."'");
            foreach ($queryidcopia->result() as $copia){
  ...
  ?>
                                    ...
                                    <th scope="row"><?php echo $number++; ?></th>
                                      <td><?php echo $copia->COP_NUMGRUPO; ?></td>
                                      <td><?php echo $copia->COP_CANTICUPOS;?></td>
                                      <td><?php echo $copia->FECHAMODIGRUPO; ?></td>
                                      <td><?php echo $horario->DIAHORARIO." - ".$horario->HORASHORARIO; ?></td>
                                      <td><?php echo $grupo->CICLOGRUPO." - ".$grupo->ANIOGRUPO; ?></td>
                                      <td><?php echo $copia->ACCIONCOPIA; ?></td>
                                      </tr>
